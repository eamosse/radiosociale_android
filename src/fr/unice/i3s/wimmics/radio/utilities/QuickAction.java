...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void perform(){
//		GridView gr = (GridView)mRootView.findViewById(R.id.gridView1);
//		MAdapter adapter = new MAdapter(actionItems,mInflater);
